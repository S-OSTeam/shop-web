    ...
    return (
        ...
        <Box component="section" className={`${styles['section-cs']}`}>
            ...
            <TabPanel value={tabVal} index={0} className={styles['panel']}>
                <FaqSearch optionData={optionProvider} parentCall={parentCall} />
            ...
            <TabPanel value={tabVal} index={1} className={styles['panel']}>
                content2
            </TabPanel>
            <TabPanel value={tabVal} index={2} className={styles['panel']}>
                content3
            </TabPanel>
            <TabPanel value={tabVal} index={3} className={styles['panel']}>
                content4
            </TabPanel>
        </Box>
    );
