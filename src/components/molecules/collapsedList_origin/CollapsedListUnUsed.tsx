    ...
    return (
        <Box component="div" className={clsN(className, styles.wrapper)}>
            <ListItemButton className={clsN(listBtnClsN, styles['list-btn'])} onClick={onClick}>
                <ListItemIcon className={clsN(listIconClsN, styles['list-btn__icon'])}>{listIcon}</ListItemIcon>
                <ListItemText
                    primary={primary}
                    className={clsN(listItemRootClsN, styles['list-btn__root'])}
                    primaryClsN={clsN(primaryClsN, styles['list-btn__root__primary'])}
                />
                {isOpen ? <ExpandLess /> : <ExpandMore />}
            </ListItemButton>
            <Collapse className={clsN(collClsN, styles.collapse)} in={isOpen} unmountOnExit>
...
CollapsedListUnUsed.defaultProps = {
...
export default CollapsedListUnUsed;
